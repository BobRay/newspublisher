...
$_lang['np_cacheable_desc'] = "(optional) Sets the flag that determines whether or not the resource is cached; default: cache_default System Setting for new resources; set to `Parent` to use parent's setting.";
...
$_lang['np_hidemenu_desc'] = "(optional) Sets the flag that determines whether or not the new page shows in the menu; default: hidemenu_default System Setting for new resources; set to `Parent to use parent's setting";
...
$_lang['np_richtext_desc'] = "(optional) Sets the flag that determines whether or Rich Text Editor is used to when editing the page content in the Manager; default: richtext_default System Setting for new resources; set to `Parent` to use parent's setting.";
...
$_lang['np_searchable_desc'] = "(optional) Sets the flag that determines whether or not the new page is included in site searches; default: search_default System Setting for new resources; set to `Parent` to us parent's setting.";
