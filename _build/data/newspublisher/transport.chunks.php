...
$chunks[1]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nprichtexttpl.chunk.tpl'));
...
$chunks[2]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/npoptiontpl.chunk.tpl'));
...
$chunks[3]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/npoptionoutertpl.chunk.tpl'));
...
$chunks[4]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/npoutertpl.chunk.tpl'));
...
$chunks[5]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nptexttpl.chunk.tpl'));
...
$chunks[6]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/npbooltpl.chunk.tpl'));
...
$chunks[7]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/npdatetpl.chunk.tpl'));
...
$chunks[8]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/npinttpl.chunk.tpl'));
...
$chunks[9]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nplistoutertpl.chunk.tpl'));
...
$chunks[10]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nplistoptiontpl.chunk.tpl'));
...
$chunks[12]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/npfiletpl.chunk.tpl'));
...
$chunks[13]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/npimagetpl.chunk.tpl'));
...
$chunks[14]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nperrortpl.chunk.tpl'));
...
$chunks[15]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nptabsjs.min.chunk.tpl'));
...
$chunks[16]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/npfielderrortpl.chunk.tpl'));
...
$chunks[17]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nptabsjs.chunk.tpl'));
