...
$_lang['np_parents_desc'] = 'Comma-separated list of parent IDs for user to select from (must be IDs); if empty, all parents are shown; to force a parent, set &parent and do not show the parent field; use 0 for root of context (new_document_in_root permission will be necessary for new resources); default: (empty)';
