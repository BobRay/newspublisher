...
$_lang['np_cancelbutton_desc'] = '(optional) Set to Yes to include a cancel button for the form that will return the user to the previous page; default: No.';
...
$_lang['np_initdatepicker_desc'] = '(optional) Initialize date picker; set this if there are any date fields; default: No';
