...
$snippets[1]->setContent(file_get_contents($sources['source_core'] . '/elements/snippets/npeditthisbutton.snippet.php'));
...
$snippets[2]->setContent(file_get_contents($sources['source_core'] . '/elements/snippets/newspublisher.snippet.php'));
